...
<?php $this->set('title_for_layout', __("Ajouter Contact")); ?>
<?php else: ?>
<?php $this->set('title_for_layout', __("Editer Contact")); ?>
<?php endif; ?>
        ...
        <div class="panel panel-cascade">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <?php if (!empty($this->request->data)): ?>
                        <?php echo __("Editer Contact"); ?>
                    <?php else: ?>
                        <?php echo __("Ajouter Contact"); ?>
                    <?php endif; ?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php echo $this->Form->input('e_mail', array('placeholder' => __("Email"), 'class' => 'form-control form-cascade-control input-small')); ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php if (empty($this->request->data)): ?>
                                <input type="date" class="form-control form-cascade-control input-small" name="data[Contact][born_date]" >
                         <?php else: ?>
                            <input type="date" value='<?php echo $this->request->data['Contact']['born_date'] ?>'class="form-control form-cascade-control input-small" name="data[Contact][born_date]" >
                    ...
                    <div class="col-md-9">
                        <select class="form-control form-cascade-control input-small" name="data[Contact][pays]" > 
                    ...
                    <div class="form-group">
                    <label class="col-md-3 control-label"><?php echo __("Societé"); ?></label>
                    <div class="col-md-9">
                        <?php echo $this->Form->input('societe_id', array('placeholder' => __("Societé"), 'class' => 'form-control form-cascade-control input-small')); ?>
                    </div>
                </div>
                <div class="form-group">
