                        ...
                        <tbody>
                            <?php foreach ($produits as $produit): ?>
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm" href="<?php echo $this->Html->url(array('controller' => 'designations', 'action' => 'edit', $produit['Designation']['id'])); ?>"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a class="btn btn-danger btn-sm" href="<?php echo $this->Html->url(array('controller' => 'designations', 'action' => 'delete', $produit['Designation']['id'])); ?>"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
