...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->Html->url(array('controller' => 'postes', 'action' => 'index')); ?>"><?php echo __("Gestion Postes"); ?></a></li>
...
<div class="panel-body">
  ...
  <?php echo $this->Form->submit(__("Ajouter"), array('div' => false, 'class' => 'btn bg-info text-white')) ?>
</div>
