<div class="page-header">
    ...
    <div class="pull-right">
        <a href="<?php echo $this->Html->url(array('controller' => 'factures', 'action' => 'index','com'=>true)); ?>" class="btn btn-primary btn-sm pull-right" style="margin-top: 4px;margin-right: 6px;"><i class="pull-right glyphicon glyphicon-arrow-left" style="margin-top: 2px;margin-left: 6px;"></i> <?php echo __('Retour Factures'); ?></a>
    </div>
