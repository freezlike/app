    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <fieldset>
                ...
                <div class="alignLeft">
                    ...
                    <input name="data[Facture][limit_date]" class="form-control" id="EchDate" type="date" style="width: 266px;" required="required">
                    <label for="EchDate">Date du Contrat</label>
                    <input name="data[Facture][date_contrat]" class="form-control" id="EchDate" type="date" style="width: 266px;" required="required">
                   
                        <?php
                    //echo $this->Form->input('limit_date', array('label' => 'Date d\'Échéance', 'type' => 'text','id'=>'EchDate'));
                    echo $this->Form->input('devise_id', array('label' => 'Devise','class'=>'form-control','required'));
                    ?>
                    <?php
                    echo $this->Form->input('user_id', array('label' => 'Client','class'=>'form-control'));
                    echo $this->Form->input('accompte', array('label' => 'Accompte', 'placeholder' => 'Accompte','class'=>'form-control','required'));
        ...
        <div class="col-md-6">
            <div class="thumbnail">
                ...
                <?php echo $this->Form->input('count', array('label' => 'Quantité', 'placeholder' => 'Quantité','class'=>'form-control','required')); ?>
