<div class="col-md-11 profile-tabs">

                  <ul id="myTab" class="nav nav-tabs">
                    <li class="active"><a href="#photos" data-toggle="tab">Ajout Societé</a></li>
                    <li class=""><a href="#friends" data-toggle="tab" onclick ="javascript:edit();">Ajout Client</a></li>
                        ...
                        <div class="row">
                            <div class="col-mod-12">
                                <ul class="breadcrumb">
                                    ...
                                    <?php if (!empty($this->request->data)): ?>
                                        <li class="active"><?php echo __("Editer Societé"); ?></li>
                                    <?php else: ?>
                                        <li class="active"><?php echo __("Ajouter Societé"); ?></li>
                                    <?php endif; ?>
                                ...
                                <div class="panel panel-cascade">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __("Nom de la Societé"); ?></label>
                                            <div class="col-md-9">
                                                <?php echo $this->Form->input('name', array('placeholder' => __("Nom de la Societé"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __("Raison Sociale"); ?></label>
                                            <div class="col-md-9">
                                                <?php echo $this->Form->input('raison_social', array('placeholder' => __("Raison Sociale"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __("Forme Juridique"); ?></label>
                                            <div class="col-md-9">
                                                ...
                                                <?php //echo $this->Form->input('forme_juridique', array('placeholder' => __("Forme Juridique"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __("Email"); ?></label>
                                            <div class="col-md-9">
                                                <?php echo $this->Form->input('mail', array('placeholder' => __("Email"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __("Fax"); ?></label>
                                            <div class="col-md-9">
                                                <?php echo $this->Form->input('fax', array('placeholder' => __("Fax"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                <?php echo $this->Form->input('adresse', array('placeholder' => __("Adresse"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                            <label class="col-md-3 control-label"><?php echo __("Activité"); ?></label>
                                            <div class="col-md-9">
                                                <?php echo $this->Form->input('activite', array('placeholder' => __("Activité"), 'class' => 'form-control form-cascade-control input-small')); ?>
                                            </div>
                                        </div>
